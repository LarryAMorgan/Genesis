...
var format_Loading_4 = new ol.format.GeoJSON();
var features_Loading_4 = format_Loading_4.readFeatures(json_Loading_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Loading_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Loading_4.addFeatures(features_Loading_4);
var lyr_Loading_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Loading_4, 
                style: style_Loading_4,
                popuplayertitle: 'Loading',
                interactive: false,
                title: '<img src="styles/legend/Loading_4.png" /> Loading'
            });
var format_Submain_5 = new ol.format.GeoJSON();
var features_Submain_5 = format_Submain_5.readFeatures(json_Submain_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Submain_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Submain_5.addFeatures(features_Submain_5);
var lyr_Submain_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Submain_5, 
                style: style_Submain_5,
                popuplayertitle: 'Submain',
                interactive: false,
                title: '<img src="styles/legend/Submain_5.png" /> Submain'
            });
var format_Flush_6 = new ol.format.GeoJSON();
var features_Flush_6 = format_Flush_6.readFeatures(json_Flush_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Flush_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Flush_6.addFeatures(features_Flush_6);
var lyr_Flush_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Flush_6, 
                style: style_Flush_6,
                popuplayertitle: 'Flush',
                interactive: false,
                title: '<img src="styles/legend/Flush_6.png" /> Flush'
            });
var format_Valve_7 = new ol.format.GeoJSON();
var features_Valve_7 = format_Valve_7.readFeatures(json_Valve_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Valve_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Valve_7.addFeatures(features_Valve_7);
var lyr_Valve_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Valve_7, 
                style: style_Valve_7,
                popuplayertitle: 'Valve',
                interactive: false,
                title: '<img src="styles/legend/Valve_7.png" /> Valve'
            });
var format_Pump_8 = new ol.format.GeoJSON();
var features_Pump_8 = format_Pump_8.readFeatures(json_Pump_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Pump_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Pump_8.addFeatures(features_Pump_8);
var lyr_Pump_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Pump_8, 
                style: style_Pump_8,
                popuplayertitle: 'Pump',
                interactive: false,
                title: '<img src="styles/legend/Pump_8.png" /> Pump'
            });
var format_Bore_9 = new ol.format.GeoJSON();
var features_Bore_9 = format_Bore_9.readFeatures(json_Bore_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Bore_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Bore_9.addFeatures(features_Bore_9);
var lyr_Bore_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Bore_9, 
                style: style_Bore_9,
                popuplayertitle: 'Bore',
                interactive: false,
                title: '<img src="styles/legend/Bore_9.png" /> Bore'
            });

lyr_GoogleHybrid_0.setVisible(true);lyr_Genesisboundary_1.setVisible(true);lyr_Pakowhaiboundary_2.setVisible(true);lyr_Blocks_3.setVisible(true);lyr_Loading_4.setVisible(true);lyr_Submain_5.setVisible(true);lyr_Flush_6.setVisible(true);lyr_Valve_7.setVisible(true);lyr_Pump_8.setVisible(true);lyr_Bore_9.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_Genesisboundary_1,lyr_Pakowhaiboundary_2,lyr_Blocks_3,lyr_Loading_4,lyr_Submain_5,lyr_Flush_6,lyr_Valve_7,lyr_Pump_8,lyr_Bore_9];
...
lyr_Loading_4.set('fieldAliases', {'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', 'Name': 'Name', });
lyr_Submain_5.set('fieldAliases', {'Shape_Leng': 'Shape_Leng', });
lyr_Flush_6.set('fieldAliases', {'Name': 'Name', });
lyr_Valve_7.set('fieldAliases', {'Name': 'Name', });
lyr_Pump_8.set('fieldAliases', {'Name': 'Name', });
lyr_Bore_9.set('fieldAliases', {'Name': 'Name', });
...
lyr_Loading_4.set('fieldImages', {'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', 'Name': 'TextEdit', });
lyr_Submain_5.set('fieldImages', {'Shape_Leng': 'TextEdit', });
lyr_Flush_6.set('fieldImages', {'Name': 'TextEdit', });
lyr_Valve_7.set('fieldImages', {'Name': 'TextEdit', });
lyr_Pump_8.set('fieldImages', {'Name': 'TextEdit', });
lyr_Bore_9.set('fieldImages', {'Name': 'TextEdit', });
...
lyr_Loading_4.set('fieldLabels', {'Shape_Leng': 'no label', 'Shape_Area': 'no label', 'Name': 'no label', });
lyr_Submain_5.set('fieldLabels', {'Shape_Leng': 'no label', });
lyr_Flush_6.set('fieldLabels', {'Name': 'no label', });
lyr_Valve_7.set('fieldLabels', {'Name': 'no label', });
lyr_Pump_8.set('fieldLabels', {'Name': 'no label', });
lyr_Bore_9.set('fieldLabels', {'Name': 'no label', });
lyr_Bore_9.on('precompose', function(evt) {
